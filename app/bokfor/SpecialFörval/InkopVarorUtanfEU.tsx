  ...
  if (mode === "steg2") {
    const gåVidare = () => {
      const extrafältObj = {
        ...
        "4500": { label: "Inköp utanför Sverige", debet: lokaltBelopp, kredit: 0 },
    ...
    return (
      <div className="bg-cyan-950 text-white">
        ...
        <div className="flex flex-col-reverse justify-between h-auto max-w-5xl px-4 mx-auto md:flex-row">
          <div className="w-full md:w-[40%] bg-slate-900 border border-gray-700 rounded-xl p-6 text-white">
            <LaddaUppFil
              fil={fil}
              setFil={setFil}
              setPdfUrl={setPdfUrl}
