...
export default function ITtjansterEU(props: Props) {
  const {
    mode,
    belopp,
    setBelopp,
  ...
  if (mode === "steg2") {
    ...
    return (
      <div className="p-6 bg-cyan-950 text-white border border-cyan-800 rounded-2xl shadow-lg">
        <h1 className="mb-6 text-3xl text-center text-white">Steg 2: IT-tjänster inom EU</h1>
    ...
    return (
      <main className="min-h-screen text-white bg-slate-950 px-4">
        <div className="max-w-5xl mx-auto bg-cyan-950 border border-cyan-800 rounded-2xl shadow-lg p-10">
          ...
          <p className="text-center font-bold text-xl mb-1">IT-tjänster inom EU</p>
