  ...
  const content = (
    <>
      ...
      <p className="text-center font-bold text-xl mb-1">
        {valtFörval.specialtyp ? valtFörval.namn : kontobeskrivning}
      </p>
        ...
        <table className="w-full text-left border border-gray-700 text-sm md:text-base bg-slate-900 rounded-xl overflow-hidden">
          ...
          <tfoot>
            <tr className="font-bold bg-cyan-900 text-white">
              ...
              <td className="p-4 text-center">{formatSEK(totalDebet || moms + beloppUtanMoms)}</td>
              <td className="p-4 text-center">{formatSEK(totalKredit || moms + beloppUtanMoms)}</td>
            </tr>
          </tfoot>
        </table>
